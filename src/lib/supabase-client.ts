...
export async function uploadImageToStorage(
  ...
  // Determine file extension and mime type from base64 prefix
  ...
  const fileName = `${campaignId}/${conceptId}-${aspectRatio}-${Date.now()}.${extension}`;
  
  // Convert base64 to blob - handle any image format prefix
